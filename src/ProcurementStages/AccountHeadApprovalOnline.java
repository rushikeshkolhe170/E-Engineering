...
public class AccountHeadApprovalOnline extends BaseTest {
	...
	@Test(description = "Updating the online vendor details", priority = 3)
	@Feature("Account Head: Online Vendor's details")
	@Severity(SeverityLevel.CRITICAL)
	public void vendorDetails() throws Exception{
		
		test = extent.createTest("Account Head: Online Vendor's details");
		//Updating vendor's details...
		driver.findElement(By.xpath("//input[@id='online']")).click();  //Online vedor selection
		driver.findElement(By.xpath("//input[@id='online_order_id']")).sendKeys("Automate online order ID");  //Online order ID
		driver.findElement(By.xpath("//input[@id='ref_source']")).sendKeys("Automate Flipkart");  //Online vendor source
